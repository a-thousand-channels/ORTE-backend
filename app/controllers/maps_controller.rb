...
class MapsController < ApplicationController
  ...
  def map_params
    params.require(:map).permit(:title, :subtitle, :text, :published, :script, :group_id, :northeast_corner, :southwest_corner, :iconset_id, :basemap_url, :basemap_attribution, :popup_display_mode, :show_annotations_on_map)
  end
end
