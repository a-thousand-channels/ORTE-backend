    ...
    respond_to do |format|
      ...
      if @map_layers.present?
        @map_layers = @map_layers
                      .includes(:image_attachment, places: [:icon, :annotations, :hyperlinks, :tags, :audios, :videos, { images: { file_attachment: :blob }, pages: {}, relations_froms: %i[relation_from relation_to] }])
