...
RSpec.describe Place, type: :model do
  ...
  describe 'CSV' do
    it 'is valid  ' do
      ...
      places = l.places
      csv_header = 'id,title,teaser,text,annotations,tags,startdate,startdate_qualifier,enddate,enddate_qualifier,lat,lon,location,address,zip,city,country'
      csv_line1 = "#{p1.id},#{p1.title},#{p1.teaser},#{p1.text},\"#{a1.person.name}:\n#{a1.title}\n#{a1.text}\n---------------\n\",\"#{p1.tag_list}\""
      csv_line2 = "#{p2.id},#{p2.title},#{p2.teaser},#{p2.text},\"#{a2.person.name}:\n#{a2.title}\n#{a2.text}\n---------------\n\",\"#{p2.tag_list}\""
      csv_line3 = "#{p3.id},#{p3.title},#{p3.teaser},#{p3.text},\"#{a3.person.name}:\n#{a3.title}\n#{a3.text}\n---------------\n\",\"#{p3.tag_list}\",2018-01-01 00:00:00.000,2018-01-01 00:00:00.000,2018-12-31 00:00:00.000,2018-12-31 00:00:00.000,50.0,10.0,A location1,An address1,12345,City1,Country1"
