...
ActiveRecord::Schema.define(version: 2022_10_13_121821) do
  ...
  create_table "annotations", charset: "utf8", force: :cascade do |t|
    t.string "title"
    t.text "text"
    t.bigint "place_id"
    t.bigint "person_id"
  ...
  create_table "build_logs", charset: "utf8", force: :cascade do |t|
    t.bigint "map_id"
    t.bigint "layer_id"
    t.string "output"
    t.string "size"
  ...
  create_table "icons", charset: "utf8", force: :cascade do |t|
    t.string "title"
    t.bigint "iconset_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "iconsets", charset: "utf8", force: :cascade do |t|
    t.string "title"
    t.text "text"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "layers", charset: "utf8", force: :cascade do |t|
    t.string "title"
    t.string "subtitle"
    t.boolean "published"
    t.bigint "map_id"
  ...
  create_table "mobility_string_translations", charset: "utf8", force: :cascade do |t|
  ...
  create_table "mobility_text_translations", charset: "utf8", force: :cascade do |t|
    t.string "locale", null: false
    t.string "key", null: false
    t.text "value"
    t.string "translatable_type"
  ...
  create_table "submission_configs", charset: "utf8", force: :cascade do |t|
