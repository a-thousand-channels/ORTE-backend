...
# ### NOTE: THis causes rspec to fail: FrozenError:can't modify frozen Array:
...
# ### NOTE: THis causes rspec to fail: FrozenError:can't modify frozen Array:, but why?
...
# subsequent deploy.
#++
# Rails.application.config.active_record.marshalling_format_version = :legacy
# 
### NOTE: THis causes rspec to fail: FrozenError:can't modify frozen Array:
