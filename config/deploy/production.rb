...
server Rails.application.credentials.dig(:deploy, :production, :server), roles: %w(app web db), user: 'orte-deploy', port: Rails.application.credentials.dig(:deploy, :production, :port)
